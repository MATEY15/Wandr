$(document).ready(function() {
	...
	// 	element: document.querySelector('.items__problem-solution'),
	// 	handler: function(direction) {
	// 		console.log('ok');
	// 	}
	// });

	// $('.items__problem-solution').each(function(){
	// 	var slice = $(this);
	// 	var waypoints = slice.waypoint(function(direction) {
	// 		if (direction === 'down') {
	// 			slice.addClass('animation-start');
	// 		} else {
	// 			//slice.removeClass('animation-start');
	// 		}
	// 	},{
	// 		offset: "90%"
	// 	});
